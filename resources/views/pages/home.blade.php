            ...
            <div class="container">
                <div class="columns">
                    <div class="column is-three-quarters">
                        ...
                        <form action="{{ @action('ShortenController@store') }}" method="post">
                            <div class="field has-addons is-block-mobile">
                                ...
                                {{--  Custom Alias Button  --}}
                                <p class="control is-not-visible is-hidden-mobile" id="custom-alias-prefix">
                                ...
                                <p class="control" id="custom-alias-control">
                                    ...
                                    !!}
                                    {{ Form::button('CUSTOM ALIAS', ['class' => 'button is-info is-large is-fullwidth-mobile', 'id' => 'custom-alias-button']) }}
                                </p>
                                <p class="control">
                                    {!! Form::hidden('is_private', 'false') !!}
                                    <button type="button" class="button is-info is-large is-fullwidth-mobile" id="is-private"><i class="fa fa-user-secret"></i></button>
                                </p>
                                {{--  Submit  --}}
                                <p class="control">
                                    {{ Form::button('<i class="fa fa-arrow-right"></i>', ['type' => 'submit', 'class' => 'button is-info is-large is-fullwidth-mobile']) }}
                                </p>
                            </div>
                        </form>
